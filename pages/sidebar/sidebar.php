    ...
    <h4 style="background-color: cadetblue; color: white;font-family: HelveBold;">Thể loại sách</h4>
    ...
    <h4 style=" background-color: cadetblue; color: white; font-family: HelveBold;">Danh mục bài viết</h4>
    <ul class="list_sidebar">
    <?php 
